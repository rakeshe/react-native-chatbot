...
class OptionsStep extends Component {
  ...
  renderOption(option) {
    const { optionContainerStyle, optionStyle, optionElementStyle } = this.props;
  ...
  render() {
    ...
    return (
      <Options className="rsc-os" style={optionContainerStyle}>
...
OptionsStep.propTypes = {
  ...
  optionContainerStyle: PropTypes.object.isRequired,
};
